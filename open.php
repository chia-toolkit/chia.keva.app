...
$authorization="Authorization:Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYyMDFhNjcwODJmMjE2MmYxNTZmNDYwNiIsImlzcyI6InplZCJ9.RAspMgghby_G55YBBTSy9V2mGuYt5MaLh4RFs-2pwhw";
				$curl = curl_init();
