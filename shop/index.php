...
echo "<style>@font-face {font-family: saoui-regular;src: url('fonts/SAOUI-Regular.otf');}html, body{background-color: #0b0c0d;color: #fff;font-size: 15px;margin: 0 auto -100px;padding:0; font-family: saoui-regular;letter-spacing:1px;}textarea-inherit {width: 90%;overflow: auto;word-break: break-all;}::-webkit-scrollbar { width: 0 !important }a:link,a:visited,a:active{transition:0.5s;color: #28f428;text-decoration: none;}a:hover { color:yellow; }input[type=\"text\"],input[type=\"submit\"] {font-size: 18px;}input[type=\"text\"],input[type=\"submit\"] {border: 1px solid #59fbea;font-family: saoui-regular;-webkit-appearance: none;-webkit-border-radius: 0;height:42px;}input[type=\"text\"] {background-color: rgb(11, 12, 13);color: #ddd;width:50%;padding-left:5px;}input[type=\"submit\"] {background-color: rgb(0, 79, 74);color: #59fbea;padding: 5px 22px;margin-left:3px;height:45px;}div{margin:1px;border:0;padding:0;}#door {margin-top:0px;font-size: 15px;}#newworld{margin-top:100px;font-size: 15px;}#tech {text-align: left;vertical-align:middle;border: 0px solid #59fbea;font-family: saoui-regular;-webkit-appearance: none;-webkit-border-radius: 0;font-size:24px;width:98%;}.crt {animation: textShadow 0.00s infinite;}#nav{/*width: 80%;*/margin: 0 auto;border: 0px solid #59fbea;}ul,li {margin: 0px;padding: 0px;list-style: none; }ul { display: flex;flex-direction: row;flex-wrap: wrap;}@keyframes fadeIn {0% {top:5%;}100% {top: 100%;}}li{border: 1px solid #59fbea;width: auto;height:45px;word-break: break-all;background-color: rgb(0, 79, 74);text-align: center;margin-top: 10px;margin-right:5px;margin-left:1px;padding-top:10px;padding-left:2px;padding-right:18px;flex:auto;}p{margin-left: 5px;}#universe {font-size: 18px;position:absolute;}p{color:#ccc;margin-top:2px;}table {color:#999;table-layout: fixed;width: 100%;border-collapse: collapse;border: 1px solid #999;}tr td{color:#999;border: 1px solid #ccc;}:hover{background-color: #eba601;color: #fff;padding:5 10 5 10;}</style>";
